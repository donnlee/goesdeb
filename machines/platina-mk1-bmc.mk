...
platina_mk1_bmc_uboot_env+='bootargs=console=ttymxc0,115200 quiet root=/dev/mmcblk0p1 rootfstype=ext4 rootwait rw init=/init ip=192.168.101.99::192.168.101.1:255.255.255.0::eth0:on'
